package com.ysr.timeline.adapter;
...
import com.ysr.timeline.R;
import com.ysr.timeline.bean.ResultData;
import com.ysr.timeline.utils.TimeTextView;
...
public class TraceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<ResultData.TracesBean> traceList = new ArrayList<>(1);
    private static final int TYPE_TOP = 0x0000;
    private static final int TYPE_NORMAL = 0x0001;
    private static final int TYPE_BOTTOM = 0x0002;

    public TraceListAdapter(Context context, List<ResultData.TracesBean> traceList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindHolder(ResultData.TracesBean trace) {
